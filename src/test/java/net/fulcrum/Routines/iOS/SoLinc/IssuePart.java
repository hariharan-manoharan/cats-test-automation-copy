...
public class IssuePart extends IOSRoutine {

    private final String routine = "Issue Part";

    private boolean isInitial = true;

    public IssuePart(iOSMobilityDriver mobilityDriver, OracleDriver oracleDriver){
