...
public class AddToShipment extends AirtelRoutine {

    private final String routine = "Add To Shipment";

    private boolean serialized = false;
    private boolean isInitial = true;

    public AddToShipment (AndroidMobilityDriver mobilityDriver, OracleDriver oracleDriver){
